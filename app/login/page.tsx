            ...
            <form onSubmit={handleLogin}>
              <div className="space-y-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    setIsLoading(true)
                    window.location.href = `https://api.intra.42.fr/oauth/authorize?client_id=u-s4t2ud-a63865c995c8eeb14a1227c650d61edb4fc4a2f7e986f97e4f49d867efede229&redirect_uri=https://42skillar.vercel.app/api/auth/callback/42&response_type=code&state=${encodeURIComponent("/competitions")}`
                  }}
                  disabled={isLoading}
                >
