                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                      ...
                      <p className="text-green-500">Começa em {new Date(competition.start_date).toLocaleString("pt-BR", { dateStyle: "short", timeStyle: "short" })}</p>
                      <p className="text-red-500">Termina em {new Date(competition.custom_end_date || competition.end_date).toLocaleString("pt-BR", { dateStyle: "short", timeStyle: "short" })}</p>
                    </div>
