...
export function JoinCompetitionButton({ 
  ...
  const getButtonText = () => {
    ...
    if (isParticipating) return "INFILTRADO"
    return "INFILTRAR"
  }
    ...
    <>
      ...
      <div className="flex flex-col gap-2 font-mono">
        <Button 
          ...
          className={`w-full sm:w-auto rounded-none border text-xs font-bold py-2.5 px-6 transition-all ${isParticipating ? 'border-zinc-700 bg-zinc-900 text-zinc-500 cursor-not-allowed' : 'border-primary bg-primary text-black hover:bg-black hover:text-primary'}`}
        >
          {getButtonText()}
        </Button>
        ...
        {repositoryUrl && (
          <a 
            ...
            className="text-xs text-center px-4 py-2.5 rounded-none bg-zinc-900 text-white hover:text-primary transition-all border border-border flex items-center justify-center gap-2 font-mono uppercase tracking-wider"
          >
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-zinc-950 rounded-none max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-border">
            <div className="flex items-center justify-between p-4 border-b border-border">
              <h2 className="text-sm font-bold text-white uppercase tracking-widest font-mono">
                {modalStep === 'choose' && 'COMO DESEJA SE INFILTRAR?'}
                {modalStep === 'create-team' && 'CRIAR NOVA FACÇÃO'}
            ...
            <div className="p-6">
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-foreground mb-2">Participar Sozinho</h3>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-foreground mb-2">Criar Equipe</h3>
                        <p className="text-sm text-[var(--md3-on-surface-variant)]">
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="text-lg font-semibold text-foreground mb-2">Juntar-se a uma Equipe</h3>
                        <p className="text-sm text-[var(--md3-on-surface-variant)]">
              ...
              {modalStep === 'create-team' && (
                <div className="space-y-4">
                  <div>
                    <Label htmlFor="teamName" className="text-foreground">Nome da Equipe</Label>
                    <Input
                      id="teamName"
                      value={teamName}
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="bg-black/30 rounded-lg p-4 mb-4">
                    <h3 className="text-foreground font-bold mb-2">📋 O que precisa ser feito:</h3>
                    <ol className="list-decimal list-inside space-y-2 text-gray-200 text-sm">
                      <li>Acesse a página de diagnóstico (botão abaixo)</li>
                      <li>Copie os scripts SQL mostrados</li>
                      <li>Execute-os no <a href="https://app.supabase.com" target="_blank" className="text-primary underline">Supabase SQL Editor</a></li>
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      className="flex-1 bg-blue-600 hover:bg-blue-700 text-foreground px-6 py-3 rounded-lg font-semibold transition-colors"
                    >
                      🔧 Ir para Diagnóstico
                    </button>
                    <button
                      onClick={() => setShowErrorModal(false)}
                      className="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-foreground rounded-lg transition-colors"
                    >
                      Fechar
                    </button>
                  </div>
